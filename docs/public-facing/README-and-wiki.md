...
- **Repository-facing verification:** the README/Wiki source work matched origin at the recorded checkpoint (`3dcef0511ea4bd15ecc30923131c6981f575d44d`). Subsequent local release-hardening commits are ahead of origin and have not been pushed; the current local head is `d99787a8f877fe718c6239cd5b370a1d89923dcb`.
