...
- [ ] **Step 3: Add the prompt, registry entry, and roster row**
...
- [ ] **Step 1: Write failing transport and rubric tests**
...
- [ ] **Step 2: Run focused tests to verify the new interfaces fail**

Run: `PYTHONPATH=. python3 -m pytest scripts/dev/test_consumer_agent.py -q`

Expected: FAIL because `consumer_agent.py` is absent.

- [ ] **Step 3: Implement bounded HTTP transport and redaction**
...
- [ ] **Step 4: Implement the score dimensions**
...
- [ ] **Step 5: Run focused tests to verify the runner passes**
...
- [ ] **Step 1: Write failing issue workflow tests**
...
- [ ] **Step 2: Run focused tests to verify issue workflow fails**

Run: `PYTHONPATH=. python3 -m pytest scripts/dev/test_consumer_agent.py -q`

Expected: FAIL because issue workflow is absent.

- [ ] **Step 3: Implement structured issue reuse/create**
...
- [ ] **Step 5: Run focused tests to verify issue workflow passes**

Run: `PYTHONPATH=. python3 -m pytest scripts/dev/test_consumer_agent.py -q`

Expected: PASS.

- [ ] **Step 6: Commit the issue workflow**
...
- [ ] **Step 2: Run the consumer agent in report-only mode**
...
- [ ] **Step 3: Review findings and create issues explicitly**
...
- [ ] **Step 4: Re-run after fixes and reconcile tracked issues**
...
- [ ] **Step 5: Commit case definitions and evidence references**
