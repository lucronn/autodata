...
3. Add deterministic regressions for the `for a` vehicle phrase and the nested terminal failure projection. Keep the Go proxy unchanged unless a test demonstrates a forwarding defect.
