...
ERROR_CODE_VALUES = ('UNAUTHENTICATED', 'ENTITLEMENT_REQUIRED', 'FORBIDDEN', 'ENTITLEMENT_REVOKED', 'DATASET_NOT_VIEWABLE', 'SECTION_FAILED', 'REVISION_NOT_FOUND', 'DUPLICATE_REQUEST', 'INVALID_EVIDENCE', 'REVIEW_REQUIRED', 'SOURCE_REVIEW_NOT_FOUND', 'SOURCE_REVIEW_CONFLICT', 'INVALID_REQUEST',)
