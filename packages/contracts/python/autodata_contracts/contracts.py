...
ERROR_CODE_VALUES = ('UNAUTHENTICATED', 'ENTITLEMENT_REQUIRED', 'ENTITLEMENT_REVOKED', 'DATASET_NOT_VIEWABLE', 'SECTION_FAILED', 'REVISION_NOT_FOUND', 'DUPLICATE_REQUEST', 'INVALID_EVIDENCE', 'REVIEW_REQUIRED',)
