(() => {
  ...
  function renderProcedure(payload, answer) {
    ...
    setText("procedure-generation", procedure.content_status === "complete"
      ? "Here’s the source-backed step-by-step procedure. Follow the steps in order."
      : "The source has not returned complete repair instructions yet. Review the warning before using this result.");
